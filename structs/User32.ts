...
class User32 {
  /**
   * Lazily binds a single `user32.dll` export and memoizes it on the class.
   *
   ...
   * ```
   */
  private static Load<T extends keyof typeof User32.Symbols>(method: T): (typeof User32)[T] {
    const skip = Object.getOwnPropertyDescriptor(User32, method)?.configurable === false;

    if (skip) {
      return User32[method];
    }

    const library = dlopen('user32.dll', { [method]: User32.Symbols[method] });
    const propertyDescriptor = { configurable: false, value: library.symbols[method] };

    Object.defineProperty(User32, method, propertyDescriptor);

    return User32[method];
  }

  /**
   * Eagerly binds multiple `user32.dll` exports at once.
   *
   ...
   * ```
   */
  public static Preload(methods?: (keyof typeof User32.Symbols)[]): void {
    methods ??= Object.keys(User32.Symbols) as (keyof typeof User32.Symbols)[];

    const symbols = Object.fromEntries(methods.filter((method) => Object.getOwnPropertyDescriptor(User32, method)?.configurable !== false).map((method) => [method, User32.Symbols[method]]));

    const library = dlopen('user32.dll', symbols);

    const propertyDescriptorMap = Object.fromEntries(Object.entries(library.symbols).map(([key, value]) => [key, { configurable: false, value }]));

    Object.defineProperties(User32, propertyDescriptorMap);

    return;
  }

  // Init removed: use `Preload()` or rely on lazy binding.

  /**
   * Raw symbol map for `dlopen('user32.dll', Symbols)`.
   *
   * Keys match exported function names; values specify `args` and `returns`
   * via `FFIType`. Consumed by `Load`/`Preload` to attach native bindings.
   */
  private static readonly Symbols = {
    ...
    ChangeDisplaySettingsExW: { args: [FFIType.cstring, FFIType.ptr, FFIType.ptr, FFIType.u32, FFIType.ptr], returns: FFIType.i32 },
    ...
    CreateDesktopExW: { args: [FFIType.cstring, FFIType.cstring, FFIType.ptr, FFIType.u32, FFIType.u32, FFIType.u32, FFIType.ptr], returns: FFIType.ptr },
    CreateDesktopW: { args: [FFIType.cstring, FFIType.cstring, FFIType.ptr, FFIType.u32, FFIType.u32, FFIType.ptr], returns: FFIType.ptr },
    ...
    CreateMDIWindowW: { args: [FFIType.cstring, FFIType.cstring, FFIType.u32, FFIType.i32, FFIType.i32, FFIType.i32, FFIType.i32, FFIType.ptr, FFIType.ptr, FFIType.i64], returns: FFIType.ptr },
    ...
    CreateWindowExW: { args: [FFIType.u32, FFIType.cstring, FFIType.cstring, FFIType.u32, FFIType.i32, FFIType.i32, FFIType.i32, FFIType.i32, FFIType.ptr, FFIType.ptr, FFIType.ptr, FFIType.ptr], returns: FFIType.ptr },
    ...
    CreateWindowStationW: { args: [FFIType.cstring, FFIType.u32, FFIType.u32, FFIType.ptr], returns: FFIType.ptr },
    ...
    DrawTextExW: { args: [FFIType.ptr, FFIType.cstring, FFIType.i32, FFIType.ptr, FFIType.u32, FFIType.ptr], returns: FFIType.i32 },
    DrawTextW: { args: [FFIType.ptr, FFIType.cstring, FFIType.i32, FFIType.ptr, FFIType.u32], returns: FFIType.i32 },
    ...
    EnumDisplayDevicesW: { args: [FFIType.cstring, FFIType.u32, FFIType.ptr, FFIType.u32], returns: FFIType.i32 },
    EnumDisplayMonitors: { args: [FFIType.ptr, FFIType.ptr, FFIType.ptr, FFIType.i64], returns: FFIType.i32 },
    EnumDisplaySettingsExW: { args: [FFIType.cstring, FFIType.u32, FFIType.ptr, FFIType.u32], returns: FFIType.i32 },
    EnumDisplaySettingsW: { args: [FFIType.cstring, FFIType.u32, FFIType.ptr], returns: FFIType.i32 },
    ...
    FindWindowExW: { args: [FFIType.ptr, FFIType.ptr, FFIType.cstring, FFIType.cstring], returns: FFIType.ptr },
    FindWindowW: { args: [FFIType.cstring, FFIType.cstring], returns: FFIType.ptr },
    ...
    GetPropA: { args: [FFIType.ptr, FFIType.cstring], returns: FFIType.ptr },
    GetPropW: { args: [FFIType.ptr, FFIType.cstring], returns: FFIType.ptr },
    ...
    GetTabbedTextExtentW: { args: [FFIType.ptr, FFIType.cstring, FFIType.i32, FFIType.i32, FFIType.ptr], returns: FFIType.u32 },
    ...
    LoadCursorFromFileW: { args: [FFIType.cstring], returns: FFIType.ptr },
    LoadCursorW: { args: [FFIType.ptr, FFIType.ptr], returns: FFIType.ptr },
    LoadIconW: { args: [FFIType.ptr, FFIType.ptr], returns: FFIType.ptr },
    LoadImageW: { args: [FFIType.ptr, FFIType.cstring, FFIType.u32, FFIType.i32, FFIType.i32, FFIType.u32], returns: FFIType.ptr },
    LoadKeyboardLayoutW: { args: [FFIType.cstring, FFIType.u32], returns: FFIType.ptr },
    ...
    MessageBoxExW: { args: [FFIType.ptr, FFIType.cstring, FFIType.cstring, FFIType.u32, FFIType.u16], returns: FFIType.i32 },
    ...
    MessageBoxW: { args: [FFIType.ptr, FFIType.cstring, FFIType.cstring, FFIType.u32], returns: FFIType.i32 },
    ...
    OpenDesktopW: { args: [FFIType.cstring, FFIType.u32, FFIType.i32, FFIType.u32], returns: FFIType.ptr },
    ...
    OpenWindowStationW: { args: [FFIType.cstring, FFIType.i32, FFIType.u32], returns: FFIType.ptr },
    ...
    PrivateExtractIconsW: { args: [FFIType.cstring, FFIType.i32, FFIType.i32, FFIType.i32, FFIType.ptr, FFIType.ptr, FFIType.u32, FFIType.u32], returns: FFIType.u32 },
    ...
    RegisterClipboardFormatW: { args: [FFIType.cstring], returns: FFIType.u32 },
    ...
    RegisterWindowMessageW: { args: [FFIType.cstring], returns: FFIType.u32 },
    ...
    RemovePropA: { args: [FFIType.ptr, FFIType.cstring], returns: FFIType.ptr },
    RemovePropW: { args: [FFIType.ptr, FFIType.cstring], returns: FFIType.ptr },
    ...
    SetDlgItemTextW: { args: [FFIType.ptr, FFIType.i32, FFIType.cstring], returns: FFIType.i32 },
    ...
    SetPropA: { args: [FFIType.ptr, FFIType.cstring, FFIType.ptr], returns: FFIType.i32 },
    SetPropW: { args: [FFIType.ptr, FFIType.cstring, FFIType.ptr], returns: FFIType.i32 },
    ...
    SetWindowTextW: { args: [FFIType.ptr, FFIType.cstring], returns: FFIType.i32 },
    ...
    ShutdownBlockReasonCreate: { args: [FFIType.ptr, FFIType.cstring], returns: FFIType.i32 },
    ...
    TabbedTextOutW: { args: [FFIType.ptr, FFIType.i32, FFIType.i32, FFIType.cstring, FFIType.i32, FFIType.i32, FFIType.ptr, FFIType.i32], returns: FFIType.i32 },
    ...
    UnregisterClassW: { args: [FFIType.cstring, FFIType.ptr], returns: FFIType.i32 },
    ...
    WinHelpW: { args: [FFIType.ptr, FFIType.cstring, FFIType.u32, FFIType.u64], returns: FFIType.i32 },
