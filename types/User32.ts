...
export type HACCEL = Pointer;
export type HANDLE = Pointer;
export type HBITMAP = Pointer;
export type HBRUSH = Pointer;
export type HCONV = Pointer;
export type HCONVLIST = Pointer;
export type HCURSOR = Pointer;
export type HDC = Pointer;
export type HDDEDATA = Pointer;
export type HDESK = Pointer;
export type HDEVNOTIFY = Pointer;
export type HDWP = Pointer;
export type HGESTUREINFO = Pointer;
export type HHOOK = Pointer;
export type HICON = Pointer;
export type HINSTANCE = Pointer;
export type HKL = Pointer;
export type HMENU = Pointer;
export type HMODULE = Pointer;
export type HMONITOR = Pointer;
export type HOOKPROC = Pointer;
export type HPOWERNOTIFY = Pointer;
export type HRAWINPUT = Pointer;
export type HRGN = Pointer;
export type HSYNTHETICPOINTERDEVICE = Pointer;
export type HSZ = Pointer;
export type HTOUCHINPUT = Pointer;
export type HWINEVENTHOOK = Pointer;
export type HWINSTA = Pointer;
